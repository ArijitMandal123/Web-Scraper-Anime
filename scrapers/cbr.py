...
def parse_cbr(soup, base_url):
    """
    Parse CBR article with correct image-to-section matching.
    ...
    data['max_side_images'] = 50  # Allow many images for CBR
    ...
    # --- RECONSTRUCT HTML ---
    html_content = reconstruct_cbr_html(sections, main_image, final_video_link, soup)
...
def reconstruct_cbr_html(sections, main_image, video_link, original_soup):
    """
    ...
    for section in sections:
        ...
        # IMPORTANT: Add images right after heading (CBR layout)
